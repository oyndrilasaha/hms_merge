...
|---|---|---|---|---|---|---|
| `EV-TEST-01` | `T-AUTH-01`, `T-AUTH-02`, `T-CSRF-01`, `T-RBAC-01`, `T-PAT-01`, `T-APT-01`, `T-APT-02`, `T-CLN-01`, `T-LAB-01`, `T-PHM-01`, `T-PHM-02`, `T-BIL-01`, `T-AUD-01`, `T-SCOPE-01`, `T-PWA-01` | [`test-results/2026-08-05-integration.txt`](test-results/2026-08-05-integration.txt) | **Pass** | 2026-08-05 AEST | Pending team attribution | Node.js 24.14.0; fresh in-memory SQLite database per test; 12 passed, 0 failed, 0 skipped. Revision is still an uncommitted working tree. |
...
- **Automated verification:** On 5 August 2026, the local Node.js 24.14.0 MVP completed 12 integration scenarios with 12 passes, 0 failures and 0 skipped tests. The suite covered authentication and session expiry, salted password hashes, CSRF and RBAC denial, patient creation, atomic appointment-conflict rejection, clinical notes, laboratory results, safe pharmacy dispensing, invoice/payment consistency, audit logging, patient scope and the PWA shell. See `EV-TEST-01`.
